...
export const SYMBOL_RULES: Readonly<Record<MarketSymbol, SymbolRule>> = {
  // Or spot : temps réel attendu pendant les sessions.
  XAUUSD: { min: 100, max: 100_000, allowNegative: false, liveMaxAgeS: 300, staleMaxAgeS: 3 * DAY },
  // Indice dollar : intraday chez Twelve Data.
  DXY: { min: 40, max: 200, allowNegative: false, liveMaxAgeS: 900, staleMaxAgeS: 3 * DAY },
