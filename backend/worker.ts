 ...
 *
 *    every 5 min    market_engine   Option B (choisie après le retrait de
 *                                  Stooq) : XAUUSD et DXY partagent
 *                                  désormais TWELVE_DATA_KEY (quota gratuit
 *                                  800 req/jour). Au cron precedent (toutes
 *                                  les 2 minutes), la charge combinee
 *                                  ~1440 req/jour depassait le quota des
 *                                  le premier jour. A 5 minutes, elle
 *                                  descend a ~576 req/jour. Le seuil LIVE
 *                                  de XAUUSD est releve a 360 s
