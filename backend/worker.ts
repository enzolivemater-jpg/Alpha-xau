 ...
 *
 *    every 2 min    market_engine   Le prix de l'or est la donnée dont tout
 *                                  dépend. 2 minutes tient sous les seuils
 *                                  LIVE de validate.ts (300 s sur XAUUSD)
 *                                  même si un run est manqué.
 *
...
export const CRON_MARKET = '*/2 * * * *';
export const CRON_NEWS = '*/15 * * * *';
